...
func (b *UserTableDbm_T) foreignLogin() *df.ForeignInfo {
	columns := []*df.ColumnInfo{
		UserTableDbm.GetColumnInfoByPropertyName("loginId"),
		LoginDbm.GetColumnInfoByPropertyName("id"),
	}

	return b.BaseDBMeta.Cfi("user_table_fkey", "Login",
		columns, 0, false, false, false, false,
		"", nil, false, "userTableList")
}	
...
func Create_UserTableDbm() {
	...
	UserTableDbm.ColumnId = df.CCI(&userTable, "id", idSqlName, "", "",
               ...
               "nextval('user_table_id_seq'::regclass)",false,"","", "","","",false,"int64")
	loginIdSqlName := new(df.ColumnSqlName)
	loginIdSqlName.ColumnSqlName = "login_id"
	loginIdSqlName.IrregularChar = false
	UserTableDbm.ColumnLoginId = df.CCI(&userTable, "login_id", loginIdSqlName, "", "",
	...
	UserTableDbm.ColumnInfoList.Add(UserTableDbm.ColumnLoginId)
	...
	UserTableDbm.ColumnInfoMap["id"]=0
		UserTableDbm.ColumnInfoMap["loginId"]=1
		UserTableDbm.ColumnInfoMap["tableName"]=2
		UserTableDbm.ColumnInfoMap["key1"]=3
		UserTableDbm.ColumnInfoMap["key2"]=4
		UserTableDbm.ColumnInfoMap["s1Data"]=5
		UserTableDbm.ColumnInfoMap["s2Data"]=6
		UserTableDbm.ColumnInfoMap["s3Data"]=7
		UserTableDbm.ColumnInfoMap["n1Data"]=8
		UserTableDbm.ColumnInfoMap["n2Data"]=9
		UserTableDbm.ColumnInfoMap["n3Data"]=10
		UserTableDbm.ColumnInfoMap["versionNo"]=11
		UserTableDbm.ColumnInfoMap["delFlag"]=12
		UserTableDbm.ColumnInfoMap["registerDatetime"]=13
		UserTableDbm.ColumnInfoMap["registerUser"]=14
		UserTableDbm.ColumnInfoMap["registerProcess"]=15
		UserTableDbm.ColumnInfoMap["updateDatetime"]=16
		UserTableDbm.ColumnInfoMap["updateUser"]=17
		UserTableDbm.ColumnInfoMap["updateProcess"]=18
