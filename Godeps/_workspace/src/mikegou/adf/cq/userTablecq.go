...
func (q *UserTableCQ) getCValueLoginId() *df.ConditionValue {
	if q.LoginId == nil {
...
func (q *UserTableCQ) SetLoginId_Equal(value int64) *UserTableCQ {
	q.regLoginId(df.CK_EQ_C, value)
	return q
}
func (q *UserTableCQ) SetLoginId_InScope(list *df.List){
	q.BaseConditionQuery.RegINS(df.CK_INS_C, list,
		 q.getCValueLoginId(), "loginId")
}
func (q *UserTableCQ) SetLoginId_NotEqual(value int64) *UserTableCQ {
	q.regLoginId(df.CK_NE_C, value)
	return q
}

func (q *UserTableCQ) SetLoginId_GreaterThan(value int64) *UserTableCQ {
	q.regLoginId(df.CK_GT_C, value)
	return q
}

func (q *UserTableCQ) SetLoginId_LessThan(value int64) *UserTableCQ {
	q.regLoginId(df.CK_LT_C, value)
	return q
}

func (q *UserTableCQ) SetLoginId_GreaterEqual(value int64) *UserTableCQ {
	q.regLoginId(df.CK_GE_C, value)
	return q
}

func (q *UserTableCQ) SetLoginId_LessEqual(value int64) *UserTableCQ {
	q.regLoginId(df.CK_LE_C, value)
	return q
}
func (q *UserTableCQ) SetLoginId_RangeOf(minNumber int64, maxNumber int64, rangeOfOption *df.RangeOfOption) error {
	return q.BaseConditionQuery.RegROO(minNumber,maxNumber,q.getCValueLoginId(),"loginId",rangeOfOption)
}	


func (q *UserTableCQ) AddOrderBy_LoginId_Asc() *UserTableCQ {
	q.BaseConditionQuery.RegOBA("loginId")
	return q
}
func (q *UserTableCQ) AddOrderBy_LoginId_Desc() *UserTableCQ {
	q.BaseConditionQuery.RegOBD("loginId")
	return q
}
func (q *UserTableCQ) regLoginId(key *df.ConditionKey, value interface{}) {
	if q.LoginId == nil {
		q.LoginId = new(df.ConditionValue)
	}
...
func (q *UserTableCQ) QueryLogin() *LoginCQ {
...
func (q *UserTableCQ) xcreateQueryLogin() *LoginCQ {
	nrp := q.BaseConditionQuery.ResolveNextRelationPath("UserTable", "Login")
...
func (q *UserTableCQ) xsetupOuterJoinLogin() {
	    cq := q.QueryLogin()
