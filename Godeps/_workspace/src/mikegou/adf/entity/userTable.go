...
func (l *UserTable) GetLoginId () int64 {
	return l.loginId
}
...
func (t *UserTable) GetAsInterfaceArray() []interface{} {
	...
	i[11] = &(t.versionNo)
	i[12] = &(t.delFlag)
	i[13] = &(t.registerDatetime)
	i[14] = &(t.registerUser)
	i[15] = &(t.registerProcess)
	i[16] = &(t.updateDatetime)
	i[17] = &(t.updateUser)
	i[18] = &(t.updateProcess)
	return i
}
...
func (t *UserTable) SetLoginId(loginId int64) {
...
func (t *UserTable) GetLogin_R() *Login{
	return t.Login_R
}
func (t *UserTable) SetLogin_R(value *Login) {
    t.Login_R = value
}
