(function() {
  ...
  $w.actions = {
    ...
    getColInfo: function(value, jsx) {
      ...
      return $c.ajaxPostJson("/ajax/dbflute", params, "application/json", $c.ajaxCallback.bind(this, params, $w.constants.$W_getColInfo_SUCCESS));
    }
  };
  $w.PageStore = Fluxxor.createStore({
    initialize: function() {
      ...
      this.bindActions($w.constants.$W_getdbs_SUCCESS, this.getdbsSuccess, $w.constants.$W_getDatabases_SUCCESS, this.getDatabasesSuccess, $w.constants.$W_getTables_SUCCESS, this.getTablesSuccess, $w.constants.$W_getColInfo_SUCCESS, this.getColInfoSuccess);
    },
